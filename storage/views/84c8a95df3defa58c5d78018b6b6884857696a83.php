    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php $__currentLoopData = getConsortia(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="form-check mb-2">
            <input type="checkbox" class="form-check-input consortia" id="<?php echo e($list->id); ?>">
            <label class="form-check-label" for="<?php echo e($list->name); ?>">
...
<form method="post" action="" id="frm_action">
  ...
  <input type="hidden" name="catalog_date" id="catalog_date" value="">
  <input type="hidden" name="url" value="<?php echo e(url('/admin/catalog')); ?>">
</form>
...
$('#tbl').DataTable({
    processing: true,
    serverSide: true,
    ajax: '<?php echo e(url("/admin/catalog/json")); ?>',
    columns: [
        { data: 'holdings_id' },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Joe\Documents\PCAARRD\elib\resources\views/admin/catalog.blade.php ENDPATH**/ ?>