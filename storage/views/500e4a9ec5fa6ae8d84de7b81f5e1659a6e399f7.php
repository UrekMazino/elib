...
<?php $__env->startSection('content'); ?>
		...
		<?php if(Auth::user() && !checkCSF()): ?> <?php echo e(session(['message' => 'Hello! Can we have a minute of your time to answer our CSF form. Thank you!'])); ?> <?php endif; ?>
		<?php if(session('message')): ?>
			<div class="alert <?php if(!checkCSF()): ?>alert-warning <?php else: ?> alert-success <?php endif; ?> text-center" style="margin-bottom:0; padding: 10px 1rem;" role="alert">
				<?php echo e(session('message')); ?> <?php if(!checkCSF()): ?> <a href="<?php echo e(url('/csf/system-review')); ?>"><u>Go to CSF</u></a> <?php endif; ?>
			</div>
		...
		<div class="modal fade" id="csfModal" tabindex="-1" role="dialog" aria-labelledby="csfModalTitle" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<h5 class="modal-title" id="csfModalLongTitle">Hello! <?php if(Auth::user()): ?> <?php echo e(Auth::user()->name); ?> <?php endif; ?></h5>
				...
				<a href="<?php echo e(url('/csf/system-review')); ?>"><button type="button" class="btn_1 btn-primary">Go to CSF</button></a>
				</div>
			</div>
			</div>
		</div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('opac.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Joe\Documents\PCAARRD\elib\resources\views/opac/index.blade.php ENDPATH**/ ?>