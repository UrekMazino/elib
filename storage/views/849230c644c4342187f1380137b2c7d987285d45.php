            ...
            <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
                    ...
                    <a href="<?php echo e(url('/admin/news/add')); ?>" class="btn p-2 btn-primary" type="button">
...
$('#tbl').DataTable({
    processing: true,
    serverSide: true,
    ajax: '<?php echo e(url("/admin/news/json")); ?>',
    columns: [
        { data: 'news_title' },
        { data: 'featured' },
        { data: 'created_by' },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Joe\Documents\PCAARRD\elib\resources\views/admin/news.blade.php ENDPATH**/ ?>