...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xl-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">AANR Collection by Consortia</h6>
                        <div id="apexBar"></div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Number of Views</h6>
                        <div id="apexLine"></div>
                </div>
            </div>
        </div>
      ...
      <div class="col-xl-12 grid-margin grid-margin-xl-0 stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <canvas id="customerFeedbackGroupedBar"></canvas>
          </div>
        </div>
      </div>
    </div>
...
<?php $__env->startSection('js'); ?>
  ...
  if ($('#apexDonut').length) {
    var options = {
      ...
      colors: [colors.primary,colors.warning,colors.danger,colors.info,colors.secondary,colors.success,colors.light],
      legend: {
        show: true,
        position: "top",
        horizontalAlign: 'center',
  ...
  $(document).ready(function () {
    let outstandingArr = [];
    let verySatisfactoryArr = [];
    let satisfactoryArr = [];
    let unsatisfactoryArr = [];
    let poorArr = [];
    $.ajax({ 
        type: 'GET', 
        url: '<?php echo e(url("/admin/csf/json")); ?>',
        async: false, 
        ...
        success: function (data) { 
            ...
            $.each(data, function(index, element) {
              outstandingArr.push(element.o);
              verySatisfactoryArr.push(element.vs);
              satisfactoryArr.push(element.s);
              unsatisfactoryArr.push(element.us);
              poorArr.push(element.p);
            });
        }
    });

    if($('#customerFeedbackGroupedBar').length) {
      new Chart($('#customerFeedbackGroupedBar'), {
        type: 'bar',
        data: {
          labels: ["Responsiveness", "Reliability", "Access & Facilities", "Communication", "Integrity", "Assurance", "Outcome"],
          datasets: [
            {
              label: "Outstanding",
              ...
              data: verySatisfactoryArr
            }, {
              label: "Satisfactory",
              backgroundColor: colors.muted,
              data: satisfactoryArr
            }, {
              label: "Unsatisfactory",
              backgroundColor: colors.warning,
              data: unsatisfactoryArr
            }, {
              label: "Poor",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Joe\Documents\PCAARRD\elib\resources\views/admin/index.blade.php ENDPATH**/ ?>