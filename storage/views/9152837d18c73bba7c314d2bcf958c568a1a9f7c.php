        ...
        <div class="col-md-6 filter-row">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 filter-div" id="filter-type">
                        <div class="row">
                            <div class="col-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Joe\Documents\PCAARRD\elib\resources\views/admin/report.blade.php ENDPATH**/ ?>