				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="strip_list wow fadeIn">
							...
							<h5><?php echo e(maxTitle($results->title_statement,200)); ?></h5>
							...
							<br/>
							<p align="right"><a href="#0" class="btn_1" onclick="submitFrm('<?php echo e($results->holdings_id); ?>')">Full description</a></p>
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('opac.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\slims\resources\views/opac/search-result-list.blade.php ENDPATH**/ ?>